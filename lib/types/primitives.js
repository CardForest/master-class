...
AbstractPrimitiveFactory.prototype.toPropertyDescriptor = function(value, control, keyPath, key) {
  var self = this;
  return {
    enumerable: true,
    configurable: false,
    ...
    set: function (newValue) {
      ...
      value = newValue;
      control.onChange('setValue', {newValue: newValue, trgKeyPath: keyPath, key: key}, self.opt);
    }
  };
};

AbstractPrimitiveFactory.prototype.snapshot = function (mapper, instance, keyPath) { // jshint ignore:line
  return instance;
};
