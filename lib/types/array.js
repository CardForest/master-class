...
function WrappedArrayMixin(value, factoryOpt, keyPath, control, parent) {
  var length;
  if (value == null) {
    value = [];
...
WrappedArrayFactory.prototype.createInstance = function(value, keyPath, control, parent) {
  if (keyPath == null) {
    keyPath = [];
  }
  if (control == null) {
  ...
  return WrappedArray(value, this.opt, keyPath, control, parent);
};
